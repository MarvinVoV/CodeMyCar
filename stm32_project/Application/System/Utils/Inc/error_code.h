...
#define ERR_MOTOR_SVR_INVALID_PARAM     MAKE_ERROR(ERR_MODULE_MOTION, ERR_LEVEL_ERROR, 0x03)
#define ERR_MOTOR_SVR_INIT_FAIL    MAKE_ERROR(ERR_MODULE_MOTION, ERR_LEVEL_ERROR, 0x04)
